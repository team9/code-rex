...
<div id="tabs" >
            ...
            <!-- li><a href="#intro">Intro</a></li> -->
				<li><a href="questions/questionShowKnwlg.php?level=one">Knowledge</a></li>
				<li><a href="questions/questionShowAlg.php?level=one">Algorithm</a></li>
				<li><a href="questions/questionShowApp.php?level=one">App Development</a></li>
